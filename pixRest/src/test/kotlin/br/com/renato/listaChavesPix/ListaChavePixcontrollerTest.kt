...
internal class ListaChavePixControllerTest {
    ...
    @Test
    fun `deve listar chaves do cliente com dados existentes`() {
        ...
        val request = HttpRequest.GET<Any>("/api/v1/clientes/$idCliente/pix")
    ...
    @Test
    fun `deve retornar lista vazia com dados invalidos`() {
        val idCliente = UUID.randomUUID()
        val listaChavesRequest = listaChavesRequest(idCliente)
